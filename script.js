document.addEventListener('DOMContentLoaded', function() {
  ...
  const studyGPTButton = document.getElementById('studyGPTButton');
  ...
  // Show AI iframe when StudyGPT button is clicked
  studyGPTButton.addEventListener('click', function() {
    aiContainer.style.display = 'block';
  });

  // Hide AI iframe when back button is clicked
